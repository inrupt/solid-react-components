...
const App = () => {
  ...
  const url = webId ? `${webId.split('/profile')[0]}/public/notificationexample/test3/inbox` : null;
  const { notifications, createNotification, createInbox } = useNotification(url, webId);
